...
const AddMngmtCmt = ({status}) => {
 ...
 const { data, setData, post, errors, processing } = useForm({
  ...
  const submit = e => {
    e.preventDefault();
    post("/admin/management-committee-store");
  };
  return (
    <>
...
/>         
   ...
   <div className="form-group row">
                    ...
                    <div className="col-sm-9">
                      <input type="text" name='designation' className="form-control col-sm-8 col-md-6" placeholder='Enter  Name' value={data.name} onChange={e=>setData("name",e.target.value)} />

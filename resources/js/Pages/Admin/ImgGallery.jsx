...
const ImgGallery = () => {
     const [sidebarOpen, setSidebarOpen] = useState(false);
      ...
      const {ImgGallery} =usePage().props;
          ...
          <div className="page-content container container-plus">
            <div className="page-header mb-2 pb-2 flex-column flex-sm-row align-items-start align-items-sm-center py-25 px-1">
              ...
              <div className="page-tools mt-3 mt-sm-0 mb-sm-n1">
                ...
                <a href='/admin/img-gallery-create' className='btn btn-primary' >Add</a>
              </div>
            </div>
 {flash?.success && (
...
{ImgGallery.map((item) => (
   ...
   <td className="align-middle" style={{ width: '20%' }}>
        <a href={`/admin/img-gallery-edit/${item.id}`}>
  ...
  onClick={(e) => {
    ...
    if (confirm('Are you sure you want to delete this image gallery?')) {
      router.delete(`/admin/img-gallery-delete/${item.id}`);
    }
  }}
>

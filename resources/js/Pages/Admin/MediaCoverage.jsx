...
const MediaCoverage = () => {
    ...
    const { flash, mediaCoverages } = usePage().props;
                                                       ...
                                                       <i className="fa fa-edit text-blue-m1 text-120"></i>
                                                        ...
                                                        <a
                                                            ...
                                                            onClick={(e) => {
                                                                ...
                                                                if (
                                                                    confirm(
                                                                        "Are you sure you want to delete this chapter menu?",
                                                                    )
                                                                ) {
                                                                    router.delete(
                                                                        `/admin/delete-media/${item.id}`,
                                                                    );
                                                                }
                                                            }}
                                                        >

          ...
          <div className="page-content container container-plus">
            <div className="page-header mb-2 pb-2 flex-column flex-sm-row align-items-start align-items-sm-center py-25 px-1">
              ...
              <div className="page-tools mt-3 mt-sm-0 mb-sm-n1">
                ...
                <a href='/admin/management-committee-create' className='btn btn-primary' >Add</a>
              </div>
            </div>
 {flash?.success && (
...
>
 ...
 <th className="border-0 bgc-white bgc-h-yellow-l3 shadow-sm">Name</th>
  <th className="border-0 bgc-white bgc-h-yellow-l3 shadow-sm">Designation</th>
...
<td>{item.designation}</td>
   ...
   <td className="align-middle" style={{ width: '20%' }}>
        <a href={`/admin/management-committee-edit/${item.id}`}>
  ...
  onClick={(e) => {
    ...
    if (confirm('Are you sure you want to delete this Management Committee?')) {
      router.delete(`/admin/management-committee-delete/${item.id}`);
    }
  }}
>

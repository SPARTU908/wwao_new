          ...
          <div className="page-content container container-plus">
            <div className="page-header mb-2 pb-2 flex-column flex-sm-row align-items-start align-items-sm-center py-25 px-1">
              ...
              <div className="page-tools mt-3 mt-sm-0 mb-sm-n1">
                ...
                <a href='/admin/founder-writer-create' className='btn btn-primary' >Add</a>
              </div>
            </div>
 {flash?.success && (
    ...
    <tr>
      <th className="td-toggle-details border-0 bgc-white shadow-sm"> S.No.
        ...
        <th className="border-0 bgc-white bgc-h-yellow-l3 shadow-sm">Title</th>
            ...
            <th className="border-0 bgc-white bgc-h-yellow-l3 shadow-sm">PDF</th>
...
<td>{item.title}</td>
              ...
              <td>{item.pdf && <a href={`/storage/${item.pdf}`} target="_blank">View PDF</a>}</td>
   ...
   <td className="align-middle" style={{ width: '20%' }}>
        <a href={`/admin/founder-writer-edit/${item.id}`}>
  ...
  onClick={(e) => {
    ...
    if (confirm('Are you sure you want to delete this Founder Writer?')) {
      router.delete(`/admin/founder-writer-delete/${item.id}`);
    }
  }}
>

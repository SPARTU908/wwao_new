...
const EditMngmtCmt = ({status, member}) => {
 ...
 const { data, setData, post, errors, processing } = useForm({
  ...
  const [preview, setPreview] = useState(
   ...
   const submit = (e) => {
     e.preventDefault();
     post(`/admin/management-committee-update/${member.id}`, {
       forceFormData: true,
     });
   };
  return (
  ...
  <div className="mt-2">
    ...
    />
                  ...
                  <div className="form-group row">
                    ...
                    <div className="col-sm-9">
                      <input type="text" name='designation' className="form-control col-sm-8 col-md-6" placeholder='Enter Designation' value={data.designation} onChange={e=>setData("designation",e.target.value)} />

...
const AddFounderWriter = ({status}) => {
 ...
 const { data, setData, post, errors, processing } = useForm({
  ...
  const submit = e => {
    e.preventDefault();
    post("/admin/founder-writer-store");
  };
  return (
    <>
...
<div className="form-group row">
                    ...
                    <div className="col-sm-9">
                        ...
                        <input onChange={e=>setData('pdf',e.target.files[0])} type="file" name='pdf' className="form-control brc-on-focus col-sm-8 col-md-6 d-inline-block" placeholder="Enter PDF"  id="pdf" />
...
export default AddFounderWriter

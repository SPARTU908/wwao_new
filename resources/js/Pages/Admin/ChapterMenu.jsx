...
const ChapterMenu = () => {
   ...
   const { flash,chapter_menu } = usePage().props;
...
>
 ...
 <td className="align-middle" style={{ width: '20%' }}>
        <a href={`/admin/edit-chapter-menu/${item.id}`}>
  ...
  onClick={(e) => {
    ...
    if (confirm('Are you sure you want to delete this chapter menu?')) {
     router.delete(`/admin/chapter-delete-menu/${item.id}`);
    }
  }}
>

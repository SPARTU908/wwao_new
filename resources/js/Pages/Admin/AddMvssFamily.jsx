...
status: 1, 
  ...
  const submit = e => {
    e.preventDefault();
    post("/admin/mvss-family-store");
  };
  return (
    <>

<Head title='AddFounderWriter'></Head>
...
{errors.email_id && (
 ...
 <div className="form-group row">
  ...
  type="file"
  name="husband_photo"
  onChange={e => setData('husband_photo', e.target.files[0])}
/>         
                        {errors.husband_photo && <div className='text-danger'>{errors.husband_photo}</div>} 
                    </div>
                  </div>
 ...
 <div className="form-group row">
  ...
  type="file"
  name="wife_photo"
  onChange={e => setData('wife_photo', e.target.files[0])}
/>         
                        {errors.wife_photo && <div className='text-danger'>{errors.wife_photo}</div>} 
                    </div>
                  </div>
